...
control = {
  ...
  'dataset' : {   u'info': u'heartBeat',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'heartBeat',
                            u'source': u'file://../test/data/heartBeat.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'a',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'a', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'a', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
