...
'/usr/local/nupic/src/nupic/swarming/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  u'a': PermuteEncoder(maxval=25000, fieldName='a', w=21, clipInput=True, minval=-16000, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(maxval=25000, classifierOnly=True, clipInput=True, minval=-16000, n=PermuteInt(28, 521), fieldname='a', w=21, type='ScalarEncoder', ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=a")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=a"
