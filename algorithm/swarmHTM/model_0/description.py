...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {'_classifierInput': {'maxval': 25000, 'classifierOnly': True, 'minval': -16000, 'clipInput': True, 'n': 275, 'fieldname': 'a', 'w': 21, 'type': 'ScalarEncoder'}, u'a': {'maxval': 25000, 'name': 'a', 'clipInput': True, 'minval': -16000, 'n': 272, 'fieldname': 'a', 'w': 21, 'type': 'ScalarEncoder'}, u'timestamp_dayOfWeek': None, u'timestamp_timeOfDay': None, u'timestamp_weekend': None}}, 'spParams': {'synPermInactiveDec': 0.05015}, 'tpParams': {'minThreshold': 11, 'activationThreshold': 14, 'pamLength': 3}, 'clParams': {'alpha': 0.050050000000000004}},
